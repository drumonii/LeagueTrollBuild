...
A `GET` request will retrieve all `Summoner Spell` s from a search term.
...
=== Find an Item
A `GET` request will retrieve all `Item` s from a search term.
...
=== Find a Champion
A `GET` request will retrieve all `Champions` s from a search term.
...
[[resources-maps-find]]
=== Find a Map
A `GET` request will retrieve all `Map` s from a search term.
